    ...
    <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
      <div className="sm:flex sm:items-center sm:justify-between">
        <ul className="flex flex-wrap gap-4 text-xs">
          <li>
            <a onClick={()=>{navigate('/terms&conditions')}} className="text-gray-500 transition hover:opacity-75 dark:text-gray-400 cursor-pointer">
              Terms & Conditions
            </a>
          </li>

          <li>
            <a onClick={()=>{navigate('/privacypolicy')}} className="text-gray-500 transition hover:opacity-75 dark:text-gray-400 cursor-pointer">
              Privacy Policy
            </a>
          </li>
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
          &copy; 2024. Sumukh JI. All rights reserved.
        </p>
      </div>
    </div>
  </div>
